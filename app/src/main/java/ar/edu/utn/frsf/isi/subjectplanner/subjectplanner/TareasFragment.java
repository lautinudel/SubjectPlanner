...
public class TareasFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        datos.add("Tarea ejemplo 1");
        datos.add("Tarea ejemplo 2");
        datos.add("Tarea ejemplo 3");


        ArrayAdapter<String> adapter = new ArrayAdapter<String>(getActivity().getApplicationContext(), android.R.layout.simple_list_item_1, datos);
